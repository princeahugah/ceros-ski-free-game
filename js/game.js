$(document).ready(function() {
    ...
    var loadedAssets = {}; //done

    var obstacleTypes = [ //done
        'tree',
        'treeCluster',
        'rock1',
        'rock2'
    ...
    var gameWidth = window.innerWidth; //done
    var gameHeight = window.innerHeight; //done
    var canvas = $('<canvas></canvas>') //done
    ...
    var clearCanvas = function() { //done
        ctx.clearRect(0, 0, gameWidth, gameHeight);
    };

    var moveSkier = function() { //done
    ...
    var getSkierAsset = function() { //done
        var skierAssetName;
        switch(skierDirection) {
            case 0:
    ...
    var drawObstacles = function() { //done
        var newObstacles = [];
    ...
    var placeInitialObstacles = function() { //done
    ...
    var placeNewObstacle = function(direction) { //done
    ...
    var placeRandomObstacle = function(minX, maxX, minY, maxY) { //done
    ...
    var calculateOpenPosition = function(minX, maxX, minY, maxY) { //done
    ...
    var checkIfSkierHitObstacle = function() { //done
        var skierAssetName = getSkierAsset();
        var skierImage = loadedAssets[skierAssetName];
        var skierRect = {
    ...
    var intersectRect = function(r1, r2) { //done
    ...
    var setupKeyhandler = function() { //done
